...
function applyMongoosePlugins() {
    ...
    glob.sync(process.cwd() + '/packages/**/server/models_ext/**/*.js').forEach(function (file) {
        ...
        if (!database.connection.models[obj.model]) {
        ...
        mongoose.model(obj.model, database.connection.models[obj.model].plugin(obj.plugin));
    });
}
...
Dolphinio.prototype.getEmailEngine = require('./emailEngine');
