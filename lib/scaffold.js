...
function buildDirectoryStructure() {
    ...
    mkdir(path + '/public/views', function () {
        ...
        mkdir(path + '/public/views/dashboard', function () {
            write(path + '/public/views/dashboard/index.html', readTemplate('client/dashboard.html'));
        });
    });
    ...
    mkdir(path + '/server/controllers', function(){
        write(path + '/server/controllers/' + name + '.js', readTemplate('server/controller.js'));
    });
    mkdir(path + '/server/models', function(){
        write(path + '/server/models/' + name + '.js', readTemplate('server/model.js'));
    });
    mkdir(path + '/server/models_ext', function(){
        write(path + '/server/models_ext/' + name + '.js', readTemplate('server/plugin.js'));
    });
    ...
    mkdir(path + '/server/preload', function () {
        write(path + '/server/preload/' + name + '.js', readTemplate('server/preload.js'));
    });
